                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
                    ...
                    <tr>
                        <td style="background-color: #0369A1; padding: 32px 24px; text-align: center;">
                            ...
                            <p style="margin: 12px 0 0 0; font-size: 14px; color: rgba(255,255,255,0.8); font-weight: 400;">Candidature envoyée avec succès</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 36px 32px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 15px; color: #1e293b; line-height: 1.6;">Votre candidature a bien été envoyée. Voici le récapitulatif :</p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 24px; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 12px 16px; background-color: #f8fafc; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #475569; font-size: 13px;">Entreprise</td>
                                    <td style="padding: 12px 16px; border-bottom: 1px solid #e2e8f0; color: #1e293b; font-size: 14px;">{{ $application->internship->company->name }}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 16px; background-color: #f8fafc; font-weight: 600; color: #475569; font-size: 13px;">Statut</td>
                                    <td style="padding: 12px 16px; color: #0369A1; font-weight: 600; font-size: 14px;">En attente de réponse</td>
                                </tr>
                            </table>

                            <p style="margin: 0 0 24px 0; font-size: 14px; color: #64748b; line-height: 1.6;">L'entreprise examinera votre candidature et vous notifiera de sa décision. Vous pouvez suivre l'avancement depuis votre espace.</p>
