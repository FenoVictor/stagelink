...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFY_EMAIL', config('mail.from.address', 'noreply@stagelink.fr')),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'noreply@stagelink.fr'),
                'name' => env('MAIL_FROM_NAME', 'StageLink'),
            ],
        ],
